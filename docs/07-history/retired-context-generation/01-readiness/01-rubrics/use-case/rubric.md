...
> Common policy lives in [`../../02-policy-and-calculation.md`](../../03-policy-and-calculation.md); final notation
> lives in [`use-case-diagram-blueprints.md`](../../../../02-diagram-schemas/03-use-case-blueprints.md).
