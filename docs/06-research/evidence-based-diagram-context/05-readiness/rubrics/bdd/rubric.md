...
> **Status:** Historical BDD-rubric snapshot. Current intended machine/human owners live under
> `docs/02-design-and-features/08-context-backed-generation/01-readiness/01-rubrics/bdd/`; runtime
...
> [`../../02-policy-and-calculation.md`](../../02-policy-and-calculation.md); final notation lives in
> [`bdd-diagram-blueprints.md`](../../../../../03-design/02-diagram-schemas/02-bdd-blueprints.md).
...
- Facets judge supported concepts, not final GraphPilot semantic types. The generator chooses the exact
  block/value/constraint/interface/enumeration/unit/quantity/association/local-type mapping and relationship
  representation.
