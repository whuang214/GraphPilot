...
> **Status:** Historical rubric-navigation snapshot. Current intended behavior is owned by
> `docs/02-design-and-features/08-context-backed-generation/01-readiness/01-rubrics/overview.md`; runtime
