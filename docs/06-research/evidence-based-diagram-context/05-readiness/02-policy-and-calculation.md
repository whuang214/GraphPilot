...
> **Status:** Historical readiness-policy snapshot. Current intended behavior is owned by
> [`02-policy-and-calculation.md`](../../../03-design/01-context-generation/01-readiness/03-policy-and-calculation.md);
...
> [`03-reviewer-json.md`](03-reviewer-json.md); each type folder under `rubrics/` contains a normative
...
| --- | --- | --- | --- |
| `activity_diagram` | `graphpilot.readiness.activity.v1` | [`rubrics/activity/rubric.json`](rubrics/activity/rubric.json) | [`rubrics/activity/rubric.md`](rubrics/activity/rubric.md) |
| `use_case_diagram` | `graphpilot.readiness.use_case.v1` | [`rubrics/use-case/rubric.json`](rubrics/use-case/rubric.json) | [`rubrics/use-case/rubric.md`](rubrics/use-case/rubric.md) |
| `bdd_diagram` | `graphpilot.readiness.bdd.v1` | [`rubrics/bdd/rubric.json`](rubrics/bdd/rubric.json) | [`rubrics/bdd/rubric.md`](rubrics/bdd/rubric.md) |

Implementation loads and validates these JSON files; their logical fields and values are normative.

## 1. Rubric envelope and schema fields

| Field | Required | Rule |
| --- | --- | --- |
| `schemaVersion` | Yes | Constant `graphpilot.readiness-rubric.v1`; versions the common rubric-document shape. |
...
| `ratingScaleVersion` | Yes | Constant `graphpilot.readiness-rating.v1`. |
...
| --- | --- | --- |
| `activity_diagram` | `graphpilot.readiness.activity.v1` | [`rubrics/activity/rubric.json`](rubrics/activity/rubric.json) |
| `use_case_diagram` | `graphpilot.readiness.use_case.v1` | [`rubrics/use-case/rubric.json`](rubrics/use-case/rubric.json) |
| `bdd_diagram` | `graphpilot.readiness.bdd.v1` | [`rubrics/bdd/rubric.json`](rubrics/bdd/rubric.json) |
...
Historical rubric definitions remain readable for interpreting canonical trace metadata, but new reviews use
...
| `not_applicable` | absent | absent | Both ref arrays empty; positive rationale required. |
| `uncertain` | absent | absent | Rationale plus matching gap/finding required; trigger refs may be cited there. |
...
live in [`03-reviewer-json.md`](03-reviewer-json.md); readiness treats `acceptedBy` as provenance.
...
1. deterministic selection-closure findings from preflight;
...
The exact algorithm implementing 04's status-first policy is:
...
[`01-readiness-reviewer.md`](01-readiness-reviewer.md) after status; no score bypasses them.
...
readiness-result fields, host loop orchestration, MCP UX, fixtures, or implementation classes.
